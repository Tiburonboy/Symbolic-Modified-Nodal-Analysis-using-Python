...
See @sec-example and @sec-test_6 for example circuits that have coupled inductors and the code to calculate $M$ and substitute a numerical value into the symbolic network equations.
...
6. See the test and problem chapters for examples on how to use Python and MNA for symbolic and numerical circuit analysis.  
