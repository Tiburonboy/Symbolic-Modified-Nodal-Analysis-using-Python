This repository contains the HTML files for my online book, _**Symbolic Modified Nodal Analysis using Python**_. The book describes a method for doing circuit analysis with Python. Archived versions of the source code consisting of JupyterLab notebooks, png and markdown text files are [here](https://github.com/Tiburonboy/Symbolic-modified-nodal-analysis/tree/master/book_backup).  
