This repository contains the HTML source code for my book, _**Symbolic Modified Nodal Analysis using Python**_. The book describes a method for doing circuit analysis with Python.
